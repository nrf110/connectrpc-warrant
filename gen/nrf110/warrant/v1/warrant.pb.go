...
type WarrantField struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ResourceType *bool   `protobuf:"varint,1,opt,name=resource_type,json=resourceType,proto3,oneof" json:"resource_type,omitempty"`
	Meta         *bool   `protobuf:"varint,2,opt,name=meta,proto3,oneof" json:"meta,omitempty"`
	MetaName     *string `protobuf:"bytes,3,opt,name=meta_name,json=metaName,proto3,oneof" json:"meta_name,omitempty"`
}

func (x *WarrantField) Reset() {
	*x = WarrantField{}
	if protoimpl.UnsafeEnabled {
...
func (x *WarrantField) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WarrantField) ProtoMessage() {}

func (x *WarrantField) ProtoReflect() protoreflect.Message {
	mi := &file_nrf110_warrant_v1_warrant_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WarrantField.ProtoReflect.Descriptor instead.
func (*WarrantField) Descriptor() ([]byte, []int) {
	return file_nrf110_warrant_v1_warrant_proto_rawDescGZIP(), []int{2}
}

func (x *WarrantField) GetResourceType() bool {
...
func (x *WarrantField) GetMeta() bool {
	if x != nil && x.Meta != nil {
		return *x.Meta
	}
	return false
...
func (x *WarrantField) GetMetaName() string {
	if x != nil && x.MetaName != nil {
		return *x.MetaName
	}
	return ""
}
...
var file_nrf110_warrant_v1_warrant_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		ExtensionType: (*WarrantField)(nil),
		Field:         3000,
		Name:          "nrf110.warrant.v1.field",
		Tag:           "bytes,3000,opt,name=field",
	...
	},
	{
		...
		Field:         3000,
		Name:          "nrf110.warrant.v1.method_resource",
		Tag:           "bytes,3000,opt,name=method_resource",
		Filename:      "nrf110/warrant/v1/warrant.proto",
	},
	{
		ExtendedType:  (*descriptorpb.MethodOptions)(nil),
		...
		Field:         3100,
		Name:          "nrf110.warrant.v1.method_subject",
		Tag:           "bytes,3100,opt,name=method_subject",
		Filename:      "nrf110/warrant/v1/warrant.proto",
	},
	{
		ExtendedType:  (*descriptorpb.MethodOptions)(nil),
	...
	},
	{
		...
		ExtensionType: (*ResourceOptions)(nil),
		Field:         3000,
		Name:          "nrf110.warrant.v1.service_resource",
		Tag:           "bytes,3000,opt,name=service_resource",
		Filename:      "nrf110/warrant/v1/warrant.proto",
	},
	{
		ExtendedType:  (*descriptorpb.ServiceOptions)(nil),
		ExtensionType: (*SubjectOptions)(nil),
		Field:         3100,
		Name:          "nrf110.warrant.v1.service_subject",
		Tag:           "bytes,3100,opt,name=service_subject",
		Filename:      "nrf110/warrant/v1/warrant.proto",
	},
}
...
var (
	// optional nrf110.warrant.v1.WarrantField field = 3000;
	E_Field = &file_nrf110_warrant_v1_warrant_proto_extTypes[0]
)

// Extension fields to descriptorpb.MethodOptions.
var (
	// optional nrf110.warrant.v1.ResourceOptions method_resource = 3000;
	E_MethodResource = &file_nrf110_warrant_v1_warrant_proto_extTypes[1]
	// optional nrf110.warrant.v1.SubjectOptions method_subject = 3100;
	E_MethodSubject = &file_nrf110_warrant_v1_warrant_proto_extTypes[2]
	// optional nrf110.warrant.v1.CheckMode check_mode = 3200;
	E_CheckMode = &file_nrf110_warrant_v1_warrant_proto_extTypes[3]
)

// Extension fields to descriptorpb.ServiceOptions.
var (
	// optional nrf110.warrant.v1.ResourceOptions service_resource = 3000;
	E_ServiceResource = &file_nrf110_warrant_v1_warrant_proto_extTypes[4]
	// optional nrf110.warrant.v1.SubjectOptions service_subject = 3100;
	E_ServiceSubject = &file_nrf110_warrant_v1_warrant_proto_extTypes[5]
)
...
var file_nrf110_warrant_v1_warrant_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
...
var file_nrf110_warrant_v1_warrant_proto_goTypes = []any{
	...
	(*WarrantField)(nil),                // 3: nrf110.warrant.v1.WarrantField
...
var file_nrf110_warrant_v1_warrant_proto_depIdxs = []int32{
	4,  // 0: nrf110.warrant.v1.field:extendee -> google.protobuf.FieldOptions
	5,  // 1: nrf110.warrant.v1.method_resource:extendee -> google.protobuf.MethodOptions
	5,  // 2: nrf110.warrant.v1.method_subject:extendee -> google.protobuf.MethodOptions
	5,  // 3: nrf110.warrant.v1.check_mode:extendee -> google.protobuf.MethodOptions
	6,  // 4: nrf110.warrant.v1.service_resource:extendee -> google.protobuf.ServiceOptions
	6,  // 5: nrf110.warrant.v1.service_subject:extendee -> google.protobuf.ServiceOptions
	3,  // 6: nrf110.warrant.v1.field:type_name -> nrf110.warrant.v1.WarrantField
	2,  // 7: nrf110.warrant.v1.method_resource:type_name -> nrf110.warrant.v1.ResourceOptions
	1,  // 8: nrf110.warrant.v1.method_subject:type_name -> nrf110.warrant.v1.SubjectOptions
	0,  // 9: nrf110.warrant.v1.check_mode:type_name -> nrf110.warrant.v1.CheckMode
	2,  // 10: nrf110.warrant.v1.service_resource:type_name -> nrf110.warrant.v1.ResourceOptions
	1,  // 11: nrf110.warrant.v1.service_subject:type_name -> nrf110.warrant.v1.SubjectOptions
...
func file_nrf110_warrant_v1_warrant_proto_init() {
	...
	file_nrf110_warrant_v1_warrant_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
